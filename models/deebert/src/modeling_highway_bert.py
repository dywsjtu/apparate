        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if not self.training:
                ...
                if not self.take_exits:
                    ...
                    all_entropies += (highway_entropy.item(),)  # NOTE: temporarily disable for torchinfo to work?
                ...
                # if highway_entropy < self.early_exit_entropy[i]:  # NOTE: temporarily enable for torchinfo to work?
                if i in self.active_ramps and highway_entropy < self.early_exit_entropy[i] and self.take_exits:  # NOTE: temporarily disable for torchinfo to work?
                # if True:
