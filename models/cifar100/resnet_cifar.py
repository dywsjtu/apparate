...
class ResNetCifar(nn.Module):
    ...
    def __init__(self, block, layers, ids=None, num_classes=NUM_CLASSES):
        self.nlayers = 0
...
def resnet20_cifar100(ids=None, **kwargs):
    model = ResNetCifar(BasicBlock, [3, 3, 3], ids, **kwargs)
    return model

def resnet32_cifar100(ids=None, **kwargs):
    model = ResNetCifar(BasicBlock, [5, 5, 5], ids, **kwargs)
    return model

def resnet44_cifar100(ids=None, **kwargs):
    model = ResNetCifar(BasicBlock, [7, 7, 7], ids, **kwargs)
    return model

def resnet56_cifar100(ids=None, **kwargs):
    model = ResNetCifar(BasicBlock, [9, 9, 9], ids, **kwargs)
    return model