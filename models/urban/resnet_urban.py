...
__all__ = ['ResNet', 'resnet18_urban', 'resnet50_urban']
...
def resnet18_urban(pretrained=False, ids=None, progress=True, **kwargs):
    ...
    model = ResNet(DistillerBasicBlock, [2, 2, 2, 2], num_classes = 3, **kwargs)

    return model


def resnet50_urban(pretrained=False, ids=None, progress=True, **kwargs):
    ...
    """
    pretrained = True
    model = ResNet(DistillerBottleneck, [3, 4, 6, 3], num_classes = 3, **kwargs)
    return model