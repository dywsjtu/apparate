...
from .resnet_urban import DistillerBasicBlock
from .resnet_urban import DistillerBottleneck

sys.path.insert(0, '../../')
from earlyexit.earlyexit_mgr import *


__all__ = ['resnet18_urban_earlyexit', 'resnet50_urban_earlyexit']
...
class ResNetEarlyExit(models.ResNet):
    def __init__(self, block, layers, ids, arch, num_classes=3, **kwargs):
...
def _resnet(arch, block, layers, ids, pretrained, num_classes=3, **kwargs):
    model = ResNetEarlyExit(block, layers, ids, arch, num_classes=3, **kwargs)
    # assert not pretrained
    return model

def resnet18_urban_earlyexit(pretrained=False, ids=None, num_classes=3, **kwargs):
    ...
    """
    return _resnet('resnet18', DistillerBasicBlock, [2, 2, 2, 2], ids, pretrained, num_classes=3,
                   **kwargs)

def resnet50_urban_earlyexit(pretrained=False, ids=None, num_classes=3, **kwargs):
    """Constructs a ResNet-50 model, with early exit branches.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', DistillerBottleneck, [3, 4, 6, 3], ids, pretrained, num_classes=3,
                   **kwargs)